        ...
        <div className="mb-10 lg:max-w-lg lg:pr-5 lg:mb-0">
          <div className="max-w-xl mb-6">
            ...
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              Undertaking Sales and Services of{" "}
              <span className="bg-gradient-to-r from-[#7A76FC] to-[#61A4EB] text-transparent bg-clip-text inline-block">
                Industrial Instruments
              </span>
            </h2>
            <p className="text-base text-gray-700 md:text-lg">
              G Vibrations Busters Pvt. Ltd. is incorporated on 10th December
              2003 . We are dealing in sales and services of Industrial
              Instruments, specially in the field of Machine Condition
              Monitoring and Protection Systems. We study the application of
              equipment and suggest the right monitoring technology
            </p>
          </div>
